...
func Get(c *gin.Context, key string) interface{} {
	...
	fmt.Println(utils.GetCurrentTimeStr() + " [WARING] " + c.Request.Method + " " + c.Request.URL.Path + " Get 缺少 " + key)
...
func GetUserId(c *gin.Context) int {
	...
	if err != nil {
		fmt.Println(utils.GetCurrentTimeStr() + " [WARING] " + c.Request.Method + " " + c.Request.URL.Path + " GetUserId 缺少 identity error: " + err.Error())
		return 0
	}
...
func GetRoleId(c *gin.Context) int {
	...
	if err != nil {
		fmt.Println(utils.GetCurrentTimeStr() + " [WARING] " + c.Request.Method + " " + c.Request.URL.Path + " GetRoleId 缺少 roleid error: " + err.Error())
		return 0
	}
...
func GetDeptId(c *gin.Context) int {
	...
	if err != nil {
		fmt.Println(utils.GetCurrentTimeStr() + " [WARING] " + c.Request.Method + " " + c.Request.URL.Path + " GetDeptId 缺少 deptid error: " + err.Error())
		return 0
	}
