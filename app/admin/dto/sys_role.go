...
type SysRoleGetPageReq struct {
	...
	RoleCode  string `form:"roleCode" search:"type:exact;column:role_key;table:sys_role" comment:"角色代码"`  // 角色代码
...
func (s *UpdateMenuAuthReq) GetId() interface{} {
	return s.RoleId
}
