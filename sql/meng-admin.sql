...
CREATE TABLE `sys_users` (
  ...
  `nick_name` varchar(128) DEFAULT '系统用户' COMMENT '用户昵称',
  `sex` varchar(10) DEFAULT NULL COMMENT '性别',
  `avatar` varchar(191) DEFAULT 'https://pic.qianxun.shop/i/2024/03/29/66059924431c9.webp' COMMENT '用户头像',
  `phone` varchar(11) DEFAULT NULL COMMENT '用户手机号',
  `email` varchar(128) DEFAULT NULL COMMENT '用户邮箱',
  `status` bigint(20) DEFAULT '1' COMMENT '用户是否被冻结 1正常 2冻结',
